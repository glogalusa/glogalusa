              ...
              $bot->sendMessage([
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'حاله الاده','callback_data'=>'status']],
                      ]
                  ])
              ]);   
          } elseif($text != null){
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"Welcome @Haking_Tools. \n - To Your IG Bussines ssvipss Tool. \n\n By ~ ",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافه حساب','callback_data'=>'login']],
                          [['text'=>'ادارة اليوزرات','callback_data'=>'grabber']],
...
لشرا نسخه عضويه او ملفات راسلنا. ",
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'• المطـور','url'=>'t.me/Haking_Tools']]
                  ]
							])
					]);
				}
            ...
            $bot->editMessageText([
                ...
                'reply_markup'=>json_encode([
                    'inline_keyboard'=>[
                        ...
                        [['text'=>'سحب من الهشتاكات #','callback_data'=>'hashtag'],['text'=>'Explore .','callback_data'=>'explore']],
                        [['text'=>'سحب من المتابعين','callback_data'=>'followers'],['text'=>"سحب من المتابعون",'callback_data'=>'following']],
                        [['text'=>"تحديد حساب : $for",'callback_data'=>'for']],
                        [['text'=>'لسته جديده','callback_data'=>'newList'],['text'=>'تأكيد اللستا الجديده','callback_data'=>'append']],
